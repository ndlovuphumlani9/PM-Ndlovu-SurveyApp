...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified">
        ...
        <tr>
            <td style="width: 259px; height: 27px;"></td>
            <td style="height: 27px; width: 447px;">
                <asp:Label ID="lblSub" runat="server" Text="" style="font-weight: bold; text-decoration: underline; font-style: italic; color: #666633; font-size: large"></asp:Label>
            </td>
            <tr>
            <td style="width: 259px; height: 27px;"></td>
            <td style="height: 27px; width: 447px;">
                <asp:Label ID="lblerr" runat="server" Text="" style="font-weight: bold; text-decoration: underline; font-style: italic; color: #666633; font-size: large"></asp:Label>
            </td>
            <td style="height: 27px"></td>
        </tr>
            <td style="height: 27px"></td>
...
&nbsp;Represents Required Fields</td>
        ...
        <tr>
            ...
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Your Surname is required" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
            ...
            <td style="width: 447px">
                    ...
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Your Name is required" ControlToValidate="TextBox2" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px; height: 42px;" class="text-center">
                <asp:Label ID="Label5" runat="server" Text="Contact Number" style="font-weight: bold; font-size: large"></asp:Label>
            </td>
            <td style="width: 447px; height: 42px;">
                    <asp:TextBox ID="TextBox3" runat="server" style="border-radius:5px" Height="30px" Width="250px" MaxLength="10"></asp:TextBox>
                    <span style="color: #FF0000">*</span></td>
            <td style="height: 42px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Your Phone Numbers is Required" ControlToValidate="TextBox3" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
            ...
            <td style="width: 447px">
                    ...
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please select the date" ControlToValidate="TextBox4" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
        ...
        <tr>
            <td style="width: 259px">
                    <asp:CheckBoxList ID="ckbFavFood" runat="server" Height="200px" style="margin-right: 0px" Width="245px">
        ...
        <tr>
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatoreato" runat="server" ControlToValidate="RadioButtonEatOut" ErrorMessage="Make sure one is selected" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatormovie" runat="server" ControlToValidate="RadioButtonMovies" ErrorMessage="Make sure one is selected" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatortv" runat="server" ControlToValidate="RadioButtonTv" ErrorMessage="Make sure one is selected" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorfm" runat="server" ControlToValidate="RadioButtonFM" ErrorMessage="Make sure one is selected" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px">&nbsp;</td>
